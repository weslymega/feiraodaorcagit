...
import { DashboardPromotion } from '../types';

interface AdminDashboardPromotionsProps {
    onBack: () => void;
    promotions: DashboardPromotion[];
    onSave: (promo: Partial<DashboardPromotion>) => void;
    onDelete: (id: string) => void;
    onToggleActive: (id: string) => void;
}

export const AdminDashboardPromotions: React.FC<AdminDashboardPromotionsProps> = ({
    onBack, promotions, onSave, onDelete, onToggleActive
}) => {
    const [isModalOpen, setIsModalOpen] = useState(false);
    const [editingPromo, setEditingPromo] = useState<Partial<DashboardPromotion> | null>(null);

    const handleOpenModal = (promo?: DashboardPromotion) => {
        if (promo) {
            ...
            <div className="bg-white sticky top-0 z-50 px-6 py-6 border-b border-gray-100 flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-gray-500">Dashboard / Home</p>
                    </div>
                </div>
                <button
            ...
            <div className="p-6">
                ...
                <div className="space-y-4">
                    ...
                    {promotions.length === 0 && (
                        <div className="bg-white rounded-3xl p-12 text-center border-2 border-dashed border-gray-100">
                            ...
                            <p className="text-sm text-gray-500">Comece adicionando seu primeiro banner promocional.</p>
                        </div>
                    )}
                </div>
                ...
                <div className="mt-8 bg-blue-50 rounded-3xl p-6 border border-blue-100">
                    <div className="flex items-center gap-3 mb-3">
                        ...
                        <h4 className="font-bold text-blue-900">Sobre os Banners</h4>
                    </div>
                    <p className="text-sm text-blue-800/80 leading-relaxed">
                        Estes banners aparecem no carrossel do topo da página inicial. Você pode configurar até 5 banners ativos simultaneamente.
                    </p>
                </div>
            </div>
