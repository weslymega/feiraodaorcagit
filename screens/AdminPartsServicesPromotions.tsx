...
import { PartsServicesPromotion } from '../types';

interface AdminPartsServicesPromotionsProps {
    onBack: () => void;
    promotions: PartsServicesPromotion[];
    onSave: (promo: Partial<PartsServicesPromotion>) => void;
    onDelete: (id: string) => void;
    onToggleActive: (id: string) => void;
}

export const AdminPartsServicesPromotions: React.FC<AdminPartsServicesPromotionsProps> = ({
    onBack, promotions, onSave, onDelete, onToggleActive
}) => {
    const [isModalOpen, setIsModalOpen] = useState(false);
    const [editingPromo, setEditingPromo] = useState<Partial<PartsServicesPromotion> | null>(null);

    const handleOpenModal = (promo?: PartsServicesPromotion) => {
        if (promo) {
        ...
        <div className="min-h-screen bg-gray-50 pb-20">
            ...
            <div className="bg-white sticky top-0 z-50 px-6 py-6 border-b border-gray-100 flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-xl font-bold text-gray-900">Gerenciar Propagandas – Peças e Serviços</h1>
                        <p className="text-xs text-gray-500">Admin / Peças e Serviços</p>
                    </div>
                </div>
                <button
            ...
            <div className="p-6">
                ...
                <div className="space-y-4">
                    ...
                    {promotions.length === 0 && (
                        <div className="bg-white rounded-3xl p-12 text-center border-2 border-dashed border-gray-100">
                            ...
                            <p className="text-sm text-gray-500">Comece adicionando seu primeiro banner promocional para Peças e Serviços.</p>
                        </div>
                    )}
                </div>
                ...
                <div className="mt-8 bg-blue-50 rounded-3xl p-6 border border-blue-100">
                    <div className="flex items-center gap-3 mb-3">
                        ...
                        <h4 className="font-bold text-blue-900">Sobre os Banners de Peças e Serviços</h4>
                    </div>
                    <p className="text-sm text-blue-800/80 leading-relaxed">
                        Estes banners aparecem no carrossel do topo da página de peças e serviços. Você pode configurar até 5 banners ativos simultaneamente.
                    </p>
                </div>
            </div>
